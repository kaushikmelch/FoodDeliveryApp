...
public class Regularmaps extends FragmentActivity implements OnMapReadyCallback,
    ...
    public static int delivery_charge ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regularmaps);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double latitude_pick = Regular.coordinates_pick[0];
        double longitude_pick = Regular.coordinates_pick[1];
        double latitude_drop = Regular.coordinates_drop[0];
        double longitude_drop = Regular.coordinates_drop[1];
        ...
        delivery_charge =  (int) ( 10 * (results[0]/1000));

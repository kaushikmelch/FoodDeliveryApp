...
public class Regulartracking extends FragmentActivity implements OnMapReadyCallback,
    ...
    Double driver_latitude = Regularotp.driver_latitude;
    Double driver_longitude = Regularotp.driver_longitude;
